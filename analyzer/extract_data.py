...
var1 = wsi_1_file.variables['var1']
var2 = wsi_1_file.variables['var2']
var3 = wsi_1_file.variables['var3']
var4 = wsi_1_file.variables['var4']
var5 = wsi_1_file.variables['var5']
...
pd.DataFrame(var_i54j71).to_csv(f'./data/var_i54j71.txt', index=False, header=False)
