...
def train():
    # main training loop
    h_net = define_model(n_hidden=richards_celia.HIDDEN, n_neurons=richards_celia.NEURONS)
...
def hyperstudy():
    ...
    study.optimize(objective, n_trials=richards_celia.HYPERTRIALS, n_jobs=4)
